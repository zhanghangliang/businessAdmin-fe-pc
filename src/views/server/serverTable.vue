  ...
  <div>
    <div class="all" style="height:100vh">
      ...
      <div class="bottom-btn">
        ...
        <el-button type="primary" size="small" @click="toPreliminaryTable" style="margin-left: 0;">申请预审</el-button>
        <el-button type="primary" size="small" @click="saveChange" style="margin-left: 0;">保存清单</el-button>
      </div>
    </div>
    <!-- 查看详细 -->
...
export default {
  ...
  methods: {
    toPreliminaryTable(){
      ...
      httpAction('/Wxoperation/serviceToAudit', {

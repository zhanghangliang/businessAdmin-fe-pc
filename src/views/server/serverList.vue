    ...
    <div>
       <div class="all">
            ...
            <!-- <div class="con-item-div">
                <p class="title">企业开办</p>
                <ul class="serve-list">
                    <li>
                        <img src="../../assets/images/icon_school.png" alt="">
                        <span>我要开学校</span>
                        <span class="first">100</span>
                    </li>
                    <li>
                        <img src="../../assets/images/icon_restaurant.png" alt="">
                        <span>我要开餐饮店</span>
                        <span class="second">100</span>
                    </li>
                    <li>
                        <img src="../../assets/images/icon_Internet_cafe.png" alt="">
                        <span>我要开网吧</span>
                        <span class="third">100</span>
                    </li>
                    <li>
                        <img src="../../assets/images/icon_Agent_bookkeeping.png" alt="">
                        <span>我要开代理记账公司</span>
                        <span>10</span>
                    </li>
                </ul>
            ...
            <div class="con-item-div">
                <p class="title">投资项目审批</p>
                <ul class="serve-list">
                    <li>
                        <img src="../../assets/images/icon_liquor.png" alt="">
                        <span>我要开酒厂</span>
                        <span class="first">100</span>
                    </li>
                    <li>
                        <img src="../../assets/images/icon_Grain_Oil.png" alt="">
                        <span>我要开粮油加工厂</span>
                        <span class="second">100</span>
                    </li>
                </ul>
            ...
            <div class="con-item-div">
                ...
                <ul class="serve-list">
                    ...
                    <li>
                        <img src="../../assets/images/icon_pass.png" alt="">
                        <span>我要办港澳通行证</span>
                        <span class="second">100</span>
                    </li>
                </ul>
...
export default {
  ...
  created () {
      console.log(`infoMixin`, infoMixin)
            ...
            if (res.code == 0) {
                ...
                if(arr.length>0){
                    arr.forEach((item,index)=>{
                        ...
                        let majorCategorys=item.itemCode==7?[2]:[1]
